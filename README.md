...
**(a)** Novae was trained on a large dataset, and is shared on [Hugging Face Hub](https://huggingface.co/collections/MICS-Lab/novae-669cdf1754729d168a69f6bd).
**(b)** Illustration of the main tasks and properties of Novae.
**(c)** Illustration of the method behing Novae (self-supervision on graphs, adapted from [SwAV](https://arxiv.org/abs/2006.09882)).
...
Here is a minimal usage guide. For more details, refer to the [documentation](https://mics-lab.github.io/novae/).
