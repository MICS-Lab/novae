...
_auto_doc_map = {
    "adata": "An `AnnData` object, or a list of `AnnData` objects. Optional is the model was initialized with `adata`.",
    "slide_key": "Optional key of `adata.obs` containing the ID of each slide.",
